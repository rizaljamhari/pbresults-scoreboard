...
export const backgroundImageFitValues = ["cover", "contain", "stretch"];
export const backgroundImagePositionValues = ["center", "top", "bottom", "left", "right"];
export const concedePositionValues = ["above", "overlapping-top"];
export const concedeAnimationValues = ["slide-horizontal", "slide-vertical", "none"];
export const teamOverlayPlacementValues = ["full-panel", "center-stamp", "top-ribbon"];
export const centerSecondaryModeValues = ["timer", "staticText", "hidden"];
export const centerSecondaryTransitionValues = ["none", "fade", "slide-up", "zoom-in"];
...
export function createThemeId(prefix = "theme") {
